<script setup>
useHead({ title: "Favorites - Investor Panel" })
...
const handleVideoClick = (video) => {
    navigateTo(`/investor/video/${video.id}`)
}
    ...
    <div class="space-y-4 md:space-y-6 py-4 md:py-6 lg:py-1">
        ...
        <div v-if="activeTab === 'property'">
            ...
            <div v-else-if="error" class="text-center py-12">
                ...
                <button
                    ...
                    class="px-4 py-2 bg-[#333365] text-white rounded-lg hover:bg-[#232355]">
                    Retry
                </button>
            </div>
            ...
            <div v-else-if="properties.length === 0" class="text-center py-12">
                ...
                <NuxtLink
                    to="/investor/search"
                    class="inline-flex items-center gap-2 px-6 py-3 bg-[#333365] text-white rounded-lg hover:bg-[#232355]">
        ...
        <div v-else-if="activeTab === 'video'">
            ...
            <div v-else-if="errorVideos" class="text-center py-12">
                ...
                <button @click="loadFavoriteVideos" class="px-4 py-2 bg-[#333365] text-white rounded-lg hover:bg-[#232355]">Retry</button>
            </div>

            <div v-else-if="videos.length === 0" class="text-center py-12">
                <Icon name="lucide:video" class="w-16 h-16 text-gray-300 mx-auto mb-4" />
                <h3 class="text-lg font-semibold text-gray-900 mb-2">No Favorite Videos</h3>
                <p class="text-gray-600 mb-6">Start adding videos to your favorites to see them here</p>
                <NuxtLink
                    to="/investor/videos"
                    class="inline-flex items-center gap-2 px-6 py-3 bg-[#333365] text-white rounded-lg hover:bg-[#232355]">
            ...
            <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                <div v-for="video in videos" :key="video.id" @click="handleVideoClick(video)" class="cursor-pointer group">
                    ...
                    <div class="mt-2">
                        <h3 class="font-semibold text-gray-900 group-hover:text-[#333365] transition-colors">{{ video.title }}</h3>
