...
<template>
    <div class="flex flex-col gap-6 w-full max-w-[1316px] mx-auto">
        ...
        <CommonCitizenSearchFilterSection v-else v-model="searchQuery" v-model:category="selectedCategory"
            v-model:home-type="selectedHomeType" v-model:price-range="selectedPriceRange" @search="handleSearch"
            @map-search="handleMapSearch" @toggle-filters="handleToggleFilters" />
        ...
        <div class="flex flex-col lg:grid lg:grid-cols-11 2xl:grid-cols-12 gap-4 lg:gap-2 2xl:gap-6">
            ...
            <div class="order-1 lg:order-1 lg:col-span-6 2xl:col-span-7">
                ...
                <div v-if="!hydrated" class="bg-white rounded-[10px] p-5 flex flex-col gap-5 animate-pulse">
                ...
                <CommonCitizenMarketChart v-else :initial-period="chartPeriod" @period-change="handlePeriodChange" />
            </div>
            ...
            <div class="order-2 lg:order-2 lg:col-span-5 2xl:col-span-5">
                ...
                <CommonCitizenSavedList v-else :home-items="savedHomeItems" :video-items="savedVideoItems"
                    @tab-change="handleSavedTabChange" @sell-all="handleSellAll" @remove-item="handleRemoveItem"
        ...
        <template v-else>
            ...
            <!-- Properties Grid -->
            <CommonCitizenPropertyGrid v-else :properties="properties" @see-all="handleSeeAllProperties"
                @property-click="handlePropertyClick" @favorite-toggle="handleFavoriteToggle" />
    ...
    <!-- Confirmation Modal -->
    <ConfirmModal v-model:isOpenConModal="showConfirmModal" title="Remove from Favorites?"
        message="This property will be removed from your saved list." @confirm="confirmRemoveFavorite" />
</template>
