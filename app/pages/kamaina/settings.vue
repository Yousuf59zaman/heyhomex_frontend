        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div
                ...
                <div class="flex items-start gap-4">
                    <div class="p-3 bg-[#FF6666]/10 rounded-lg group-hover:bg-[#FF6666]/20 transition-colors">
                        <Icon 
                            :name="section.icon" 
                            class="w-6 h-6 text-[#FF6666]" />
                    </div>
                    <div class="flex-1">
                        <h3 class="text-lg font-semibold text-gray-900 group-hover:text-[#FF6666] transition-colors">
                            {{ section.title }}
                        </h3>
                        <p class="text-sm text-gray-600 mt-1">
                            {{ section.description }}
                    ...
                    <Icon 
                        ...
                        class="w-5 h-5 text-gray-400 group-hover:text-[#FF6666] transition-colors" />
                </div>
            </div>
        </div>
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-6 mt-6">
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center py-2">
                    ...
                    <span class="text-sm font-medium text-gray-900">
                        {{ new Date(citizen_user?.data?.created_at).toLocaleDateString() || 'N/A' }}
                    </span>
                </div>
            </div>
        </div>
