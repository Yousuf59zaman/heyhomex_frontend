        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div
                ...
                <div class="flex items-start gap-4">
                    <div class="p-3 bg-[#6E9EF3]/10 rounded-lg group-hover:bg-[#6E9EF3]/20 transition-colors">
                        <Icon :name="section.icon" class="w-6 h-6 text-[#6E9EF3]" />
                    </div>
                    <div class="flex-1">
                        <h3 class="text-lg font-semibold text-gray-900 group-hover:text-[#6E9EF3] transition-colors">{{ section.title }}</h3>
                        <p class="text-sm text-gray-600 mt-1">{{ section.description }}</p>
                    </div>
                    <Icon name="lucide:chevron-right" class="w-5 h-5 text-gray-400 group-hover:text-[#6E9EF3] transition-colors" />
                </div>
            </div>
        </div>
