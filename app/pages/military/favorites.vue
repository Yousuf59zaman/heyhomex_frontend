...
<template>
    <div class="space-y-4 lg:space-y-6 w-full max-w-[1316px] mx-auto">
        <!-- Top Banner Ad -->
        <FeatureDisplay placement-slug="military-favorites-top-banner" />
        ...
        <div v-else-if="activeTab === 'video'">
            ...
            <div v-else-if="errorVideos" class="text-center py-12">
                ...
                <button @click="loadFavoriteVideos" class="px-4 py-2 bg-[#6E9EF3] text-white rounded-lg hover:bg-[#5E8EE3]">Retry</button>
            </div>
