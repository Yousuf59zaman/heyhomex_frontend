<script setup>
    ...
    const updateHandler = async () => {
        ...
        try {
            ...
            const getData = await $fetchAdmin(`admin/years/${props.item.id}`, {
                method: "PUT",
                body: formData.value,
            })
    ...
    const createHandler = async () => {
        ...
        try {
            isLoading.value = true
            const getData = await $fetchAdmin(`admin/years`, {
                method: "POST",
                body: formData.value,
            })
            response_modal.value = getData
            ...
            <div class="flex items-center gap-4">
                <div class="flex-auto">
                    ...
                    <InputNumber
                        ...
                        class="w-full"
                        :useGrouping="false"
                        placeholder="i.e. 2025"
                        :class="
                            validations_errors.year
                    ...
                    <InputError
                        class="text-sm mt-1"
                        :message="validations_errors.year" />
                </div>
            </div>
