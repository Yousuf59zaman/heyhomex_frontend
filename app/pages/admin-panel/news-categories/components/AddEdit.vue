...
const updateHandler = async () => {
    ...
    try {
        ...
        const getData = await $fetchAdmin(`admin/news-categories/${props.item.id}`, {
            method: 'PUT',
            body: formData.value,
        });
    ...
    <Dialog v-model:visible="visible" modal :closable="false" :style="{ width: '30rem' }"
        ...
        <div class="grid grid-cols-1 gap-4">
            <div class="flex items-center gap-4">
                ...
                <div class="flex-auto">
                    <LazyInputText v-model="formData.title" class="w-full" placeholder="i.e. News"
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex-auto">
                    <LazyInputText v-model="formData.slug" class="w-full" placeholder="i.e. slug-news"
