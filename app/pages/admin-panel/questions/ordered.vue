        ...
        <div class="h-full w-full overflow-auto">
            <div class="w-full flex flex-wrap md:flex-nowrap justify-between items-center gap-4 mb-4">
                <div class="flex items-center gap-3">
                    <Button icon="fa-solid fa-arrow-left" severity="secondary" @click="goBack" label="Back to Questions"
                        class="text-xs" />
                    ...
                    <div class="p-4">
                        <div class="custom_table overflow-auto border-b border-gray-200">
                            <table class="table table-auto">
                                ...
                                " tag="tbody" :list="data" handle=".drag-handle"
                                    :group="{ name: 'ordered-questions' }" @start="onDragStart" @end="onDragEnd">
