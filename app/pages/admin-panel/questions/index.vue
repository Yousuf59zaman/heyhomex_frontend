        ...
        <div class="h-full w-full overflow-auto">
            <div class="w-full flex flex-wrap md:flex-nowrap justify-between items-center gap-4 mb-4">
                ...
                <div v-else class="flex gap-2">
                    <Button label="View Ordered Questions" @click="navigateTo('/admin-panel/questions/ordered')"
                        severity="info" icon="fa-solid fa-list-ol" class="text-xs" />
                    <Button label="Create Question" @click="addNew" class="text-xs" />
                </div>
            </div>
            ...
            <div class="pb-2 flex flex-col justify-between w-full">
                <div class="mt-4 border border-gray-200 rounded-lg bg-white dark:bg-gray-800">
                                    ...
                                    <tr v-for="element in data" :key="element.id">
                                        ...
                                        <td>
                                            <div class="flex justify-center items-center">
                                                <span v-if="element.is_active" class="text-green-600">
                                        ...
                                        <td>
                                            <div class="flex justify-center items-center">
                                                ...
                                                <Button v-else @click="
                                                    ...
                                                    " label="Add to Order" size="small" severity="success"
                    ...
                    <AddEdit :isOpenModal="isOpenModal" :item="item" :modalTitle="modalTitle" @close="cancelModal"
                    ...
                    <!-- Add to Order Modal -->
                    <Dialog v-model:visible="isOrderModalOpen" modal :header="`Add Question to Order`"
                        :style="{ width: '30rem' }">
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex flex-col gap-2">
                                <label for="orderInput" class="text-sm font-medium text-gray-700 dark:text-gray-300">
                                    Order Number (1-{{ maxOrder }})
                                </label>
                                <InputNumber id="orderInput" v-model="orderInput" :min="1" :max="maxOrder" :step="1"
                                    showButtons buttonLayout="horizontal" class="w-full" :pt="{
                        ...
                        <template #footer>
                            <div class="flex justify-end gap-2">
                                <Button label="Cancel" severity="secondary" @click="cancelOrderModal" />
                                <Button label="Add to Order" severity="success" @click="addToOrder" />
                            </div>
                        </template>
                    </Dialog>
                </div>
