        ...
        <div class="grid grid-cols-1 gap-4">
            <div class="flex items-center gap-4">
                ...
                <div class="flex-auto">
                    ...
                    <InputText v-model="formData.title" class="w-full" placeholder="i.e. Event Category"
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex-auto">
                    ...
                    <InputText v-model="formData.slug" class="w-full" placeholder="i.e. event-category"
