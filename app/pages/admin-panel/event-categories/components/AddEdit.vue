...
const updateHandler = async () => {
    ...
    try {
        ...
        const getData = await $fetchAdmin(`admin/event-categories/${props.item.id}`, {
            method: 'PUT',
            body: formData.value,
        });
...
const createHandler = async () => {
    ...
    try {
        isLoading.value = true;
        const getData = await $fetchAdmin(`admin/event-categories`, {
            method: 'POST',
            body: formData.value,
        });
        response_modal.value = getData;
    ...
    <Dialog v-model:visible="visible" modal :closable="false" :style="{ width: '30rem' }"
        ...
        <div class="grid grid-cols-1 gap-4">
            <div class="flex items-center gap-4">
                ...
                <div class="flex-auto">
                    <LazyInputText v-model="formData.title" class="w-full" placeholder="i.e. Event Category"
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex-auto">
                    <LazyInputText v-model="formData.slug" class="w-full" placeholder="i.e. event-category"
