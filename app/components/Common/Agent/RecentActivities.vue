            ...
            <div v-for="activity in activities" :key="activity.id" class="flex items-start space-x-4">
                ...
                <div class="flex-shrink-0 mt-1">
                    <div class="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center">
                        <Icon :name="getActivityIcon(activity.type)" class="w-5 h-5 text-gray-600" />
                    </div>
                </div>
                ...
                <div class="flex flex-col items-end space-y-2 text-sm">
                    ...
                    <div class="flex items-center text-gray-500">
                        ...
                        <img src="/svg/icons/dates.svg" class="w-4 h-4 mr-1" alt="" />
                    ...
                    <div class="flex items-center text-gray-500">
                        ...
                        <img src="/svg/icons/status.svg" class="w-4 h-4 mr-1" alt="" />
                        <span class="text-xs mr-2">Status:</span>
                        <span class="px-2 py-1 text-xs font-medium rounded-md border"
