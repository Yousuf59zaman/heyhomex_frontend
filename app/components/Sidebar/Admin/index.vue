...
<template>
    <div
        v-if="isMobile && hamburger_button"
        class="fixed inset-0 bg-black/50 z-10 transition-opacity"
        @click="closeSidebar"></div>

    <div
        class="fixed admin-layout h-full top-0 left-0 flex flex-col transition-all duration-300 ease-in-out transform dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 bg-white dark:text-white z-20"
        :class="[
        ...
        <div
            ...
            <NuxtLink
                :to="'/'"
                :class="!hamburger_button ? 'hidden' : ''">
                <ApplicationLogo :width="'140px'" />
            </NuxtLink>
            <div
                class="w-full flex h-14"
                :class="hamburger_button ? 'justify-end' : 'justify-center'">
                <button
        ...
        <div
            v-if="isMenuLoading && hamburger_button"
            class="overflow-hidden overflow-y-auto py-2">
            <div
                v-for="index in 20"
                :key="index"
                class="w-full">
        ...
        <div
            v-else-if="isMenuLoading && !hamburger_button"
            class="overflow-hidden overflow-y-auto py-2">
            <div
                v-for="index in 20"
                :key="index"
        ...
        <div
            ...
            <div
                ...
                :key="index"
                class="relative">
                <SidebarAdminRecursiveMenuItem
                    :item="item"
                    :current-path="currentPath"
                    :is-expanded="hamburger_button"
