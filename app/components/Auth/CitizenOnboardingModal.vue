    ...
    <Dialog
        ...
        <template #header>
            <div class="absolute right-6 top-6 z-50">
                <button
                    @click="closeHandler"
                    class="w-10 h-10 flex items-center justify-center bg-[#d9d9d9] text-[#4b5563] cursor-pointer rounded-full transition-all duration-200 focus:outline-none hover:bg-[#cfd1d4] shadow-sm">
                    <i class="pi pi-times text-lg leading-none"></i>
                </button>
            </div>
            ...
            <div class="flex items-center justify-between w-full">
                ...
                <div
                    ...
                    <div
                        ...
                        :key="step"
                        :class="[
                            'h-[6px] w-[65px] rounded-full transition-all duration-300',
            ...
            <div
                ...
                <div class="flex flex-col sm:flex-row gap-[24px]">
                    <button
                        @click="handleNext"
                        outlined
                        class="flex-1 basis-0 w-full h-[52px] px-4 py-3 bg-[#F0F1F3] hover:bg-[#e5e7eb] disabled:bg-gray-300 text-[#121a22] text-base font-bold leading-[24px] rounded-[12px] transition-colors duration-200 flex items-center justify-center">
                        Start Over
                    </button>
                    ...
                    <button
                        ...
                        class="flex-1 basis-0 w-full h-[52px] px-5 py-3.5 text-base font-bold leading-[24px] rounded-[12px] transition-colors duration-200 flex items-center justify-center gap-2 bg-[#18222c] hover:bg-[#0F172A] text-white disabled:bg-gray-400">
                        Next
                    </button>
                </div>
            </div>
            ...
            <div
                ...
                <div class="space-y-3">
                    <button
                        ...
                        :loading="loading"
                        loadingIcon="pi pi-spin pi-spinner"
                        class="w-full px-6 py-3 bg-[#18222c] hover:bg-[#0F172A] disabled:bg-gray-400 text-white font-medium rounded-[12px] transition-colors duration-200 flex items-center justify-center">
