            ...
            <div
                ...
                <div class="flex flex-col gap-9">
                    ...
                    <div
                        ...
                        <div
                            ...
                            :class="[
                                'inline-flex min-h-14 items-center px-5 py-2.5 rounded-full cursor-pointer transition-all duration-200 text-xs sm:text-sm font-medium leading-tight whitespace-pre',
                ...
                <div class="flex flex-col sm:flex-row gap-6">
                    <button
                        @click="handleNext"
                        outlined
                        class="flex-1 basis-0 w-full h-13 px-4 py-3 bg-[#F0F1F3] hover:bg-[#e5e7eb] disabled:bg-gray-300 text-[#121a22] text-base font-bold leading-6 rounded-xl transition-colors duration-200 flex items-center justify-center">
                        Start Over
                    </button>
                    ...
                    <button
                        ...
                        class="flex-1 basis-0 w-full h-13 px-5 py-3.5 text-base font-bold leading-6 rounded-xl transition-colors duration-200 flex items-center justify-center gap-2 bg-[#18222c] hover:bg-[#0F172A] text-white disabled:bg-gray-400">
                        Next
                    </button>
                </div>
            </div>
