                        ...
                        <div class="relative">
                            ...
                            <template v-if="hydrated">
                                <LazyInputText id="login_id" name="login_id" autocomplete="username" type="text"
                                    ...
                                    class="w-full pl-12 pr-4 py-4 rounded-xl bg-gray-50 border-0 focus:ring-2 focus:ring-purple-500 transition-all duration-200"
                        ...
                        <div class="relative">
                            ...
                            <template v-if="hydrated">
                                <LazyInputText id="password" name="password" autocomplete="current-password"
                                    ...
                                    class="w-full pl-12 pr-12 py-4 rounded-xl bg-gray-50 border-0 focus:ring-2 focus:ring-purple-500 transition-all duration-200"
