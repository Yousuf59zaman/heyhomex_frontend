        ...
        <div class="px-6 pt-8 pb-2 space-y-7">
            ...
            <div class="flex justify-center gap-5">
                <input
                    ...
                    inputmode="numeric"
                    maxlength="1"
                    class="w-[92px] h-14 text-center text-lg font-semibold border border-[#cfdbe8] rounded-[8px] text-[#121A22] focus:ring-2 focus:ring-[#18222c]/20 focus:border-[#18222c] transition-colors"
