<script setup>
const emit = defineEmits(["update:modelValue","go-to-email","show-login","back","close"]);
  ...
  >
    <template #header>
      <div class="w-full px-6 pt-6 pb-2">
        <div class="flex items-center justify-center relative">
          ...
          <!-- Title -->
          <h2 class="text-xl font-semibold text-[#121A22]">Create account</h2>
        </div>
      </div>
    </template>
    ...
    <div class="px-6 pb-6 space-y-4">
      ...
      <button
        ...
        type="button"
        class="w-full px-6 py-3.5 bg-white hover:bg-gray-50 text-gray-900 font-medium border border-gray-300 rounded-lg transition-colors duration-200 flex items-center justify-center gap-3"
      >
