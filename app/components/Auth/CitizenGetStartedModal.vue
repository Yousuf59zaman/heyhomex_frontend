            ...
            <div class="mx-auto flex w-full max-w-[42rem] flex-col gap-12">
                ...
                <div class="flex flex-col gap-2.5">
                    <button
                        ...
                        type="button"
                        :disabled="isLoading"
                        class="flex h-13 w-full items-center justify-center rounded-xl bg-[#18222c] px-5 text-base font-bold leading-6 text-white transition-colors duration-200 hover:bg-[#111822] disabled:cursor-not-allowed disabled:opacity-50">
                        Continue with email
                    </button>
                    ...
                    <button
                        ...
                        class="flex h-13 w-full items-center justify-center gap-2 rounded-xl border border-[#cfdbe8] bg-white px-5 text-base font-bold leading-6 text-[#18222c] transition-colors duration-200 hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50">
                        <svg
