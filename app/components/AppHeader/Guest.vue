...
<template>
    <nav :class="[
        ...
        <div class="relative flex items-center justify-between px-4 sm:px-6 md:px-8 lg:px-12">
            <!-- Left Spacer (hidden on mobile) -->
            <div class="md:w-[200px]">
                <img class="hidden sm:block lg:hidden" src="/images/home/home_logo.png" alt="" />
            </div>
            ...
            <div :class="[
                ...
                <div class="flex items-center space-x-3">
                    <NuxtLink to="/#">
                        <ApplicationLogo :width="'100%'" :height="'1.625rem'" class="filter brightness-0 invert" />
                    </NuxtLink>
                </div>
            </div>
            ...
            <div class="ml-auto flex items-center">
                <!-- Desktop Menu -->
                <div v-if="admin_user" class="hidden md:flex items-center space-x-4">
        ...
        <transition enter-active-class="transition duration-200 ease-out" enter-from-class="opacity-0 -translate-y-2"
            ...
            <div v-else-if="isMobileMenuOpen && admin_user" class="md:hidden bg-[#1a2530] border-t border-gray-700">
                <div class="px-4 py-4 space-y-3">
                    <NuxtLink to="/admin-panel" @click="toggleMobileMenu"
                        class="block w-full text-center py-[0.625rem] px-[1.5rem] text-base bg-white border rounded-lg hover:bg-gray-100 transition-colors">
                        Admin Panel
                    </NuxtLink>
                </div>
